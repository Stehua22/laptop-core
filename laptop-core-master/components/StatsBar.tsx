  ...
  return (
    <div style={{
      ...
      {STATS.map((s, i) => (
        <div
          key={s.key}
          className="animate-fade-up stats-card"
          style={{
          ...
          onMouseEnter={(e) => {
            ...
            el.style.boxShadow = `0 8px 32px rgba(0,0,0,0.12), 0 0 0 1px ${s.color}33`;
          }}
          onMouseLeave={(e) => {
            const el = e.currentTarget as HTMLElement;
        ...
        >
          <div style={{
            ...
            width: 80, height: 80,
            background: `radial-gradient(circle at top right, ${s.color}28, transparent 70%)`,
            pointerEvents: "none",
          }} />
          <div style={{
