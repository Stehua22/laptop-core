...
export default function Laptop3DViewer() {
  ...
  useEffect(() => {
    ...
    // Keyboard deck surface (slightly darker inset)
    ...
    // initial open angle (rotate around x, hinge at bottom of pivot)
  ...
  // autoRotate needs a ref since the animate loop closure only reads it once
