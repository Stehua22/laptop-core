      ...
      <div style={{ minHeight: "100vh", background: "var(--bg)", color: "var(--text)" }}>
        ...
        <div style={{ borderBottom: "1px solid var(--border)", background: "rgba(var(--bg-rgb, 10,12,18),0.8)", backdropFilter: "blur(12px)", position: "sticky", top: 0, zIndex: 100 }}>
          <div style={{ maxWidth: 1100, margin: "0 auto", padding: "14px 20px", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
            <button onClick={() => router.push("/")} style={{ background: "transparent", border: "1px solid var(--border)", borderRadius: 8, padding: "7px 16px", cursor: "pointer", color: "var(--text-muted)", fontSize: 13, display: "flex", alignItems: "center", gap: 6 }}>
              ← Back
            </button>
        ...
        <div style={{ maxWidth: 1100, margin: "0 auto", padding: "40px 20px" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 420px", gap: 32, alignItems: "start", marginBottom: 48 }}>
            ...
            {/* Image card */}
            <div style={{
              background: "linear-gradient(135deg, rgba(139,179,245,0.07) 0%, rgba(106,247,184,0.04) 100%)",
              ...
              {laptop.image_url && !imgError ? (
                <img
                  src={laptop.image_url} alt={laptop.model}
                  onLoad={() => setImgLoaded(true)} onError={() => setImgError(true)}
                  style={{ maxWidth: "100%", maxHeight: 280, objectFit: "contain", opacity: imgLoaded ? 1 : 0, transition: "opacity 0.4s", position: "relative", zIndex: 1 }}
                />
              ) : (
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 0 }}>
              ...
              {/* Model */}
              <h1 style={{ fontSize: "clamp(1.6rem, 3vw, 2.2rem)", fontWeight: 900, letterSpacing: "-0.04em", marginBottom: 6, lineHeight: 1.15 }}>
                {laptop.model}
              </h1>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 20, marginBottom: 40 }}>
            ...
            <div style={{ background: "linear-gradient(135deg, rgba(106,247,184,0.05) 0%, transparent 100%)", border: "1px solid rgba(106,247,184,0.15)", borderRadius: 16, padding: "22px 24px" }}>
              <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 16 }}>
                <h2 style={{ fontSize: 14, fontWeight: 700, display: "flex", alignItems: "center", gap: 8, margin: 0 }}>
              ...
              {editingPros ? (
                ...
                <p style={{ fontSize: 13, color: "var(--text-dim)", margin: 0 }}>{unlocked ? "Click Edit to add pros." : "No pros added yet."}</p>
              )}
            </div>
            ...
            <div style={{ background: "linear-gradient(135deg, rgba(247,106,106,0.05) 0%, transparent 100%)", border: "1px solid rgba(247,106,106,0.15)", borderRadius: 16, padding: "22px 24px" }}>
              ...
              {editingCons ? (
                ...
                <p style={{ fontSize: 13, color: "var(--text-dim)", margin: 0 }}>{unlocked ? "Click Edit to add cons." : "No cons added yet."}</p>
              )}
            </div>
          </div>
